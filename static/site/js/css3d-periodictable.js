...
import { CSS3DRenderer, CSS3DObject } from "three/libs/CSS3DRenderer.js";
import TWEEN from "three/libs/tween.module.js";
...
export class Main {
  ...
  constructor() {
    ...
    this.controller.maxDistance = 6000;
    this.controller.addEventListener('change', (event) => { this.renderer.render(this.scene, this.camera) });
    ...
    buttonSphere.addEventListener('click', (event) => {
      this.transform(this.targets.sphere, 2000);
    });

    const buttonHelix = document.getElementById("helix");
    buttonHelix.addEventListener('click', (event) => {
